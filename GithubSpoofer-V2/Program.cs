...
namespace GithubSpoofer_V2
{
    ...
    class Program
    {
        ...
        static string Driver = "https://github.com/Elvinfx/Spoof-Driver/raw/main/soardrv.sys";
        static string Mapper = "https://github.com/Elvinfx/Spoof-Driver/raw/main/kdmapper.exe";
        ...
        static void BackgroundTitle()
        {
            while (true)
            {
                ...
                string title2 = "Elvin | Developement";
